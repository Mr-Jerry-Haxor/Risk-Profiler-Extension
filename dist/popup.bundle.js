...
<w:settings xmlns:w="${ye}">
    <w:updateFields w:val="true"/>
</w:settings>`,Qe=new TextEncoder,xt=Bt();async function He(e){let t=new Blob([Ct(e)],{type:"application/vnd.openxmlformats-officedocument.wordprocessingml.document"}),n=URL.createObjectURL(t),s=document.createElement("a");s.href=n,s.download=`${qt(e?.assetName||"application")}_RISK-PRofiler_review_notes.docx`,s.click(),URL.revokeObjectURL(n)}function Ct(e){return Ft([{name:"[Content_Types].xml",content:At},{name:"_rels/.rels",content:Et},{name:"word/document.xml",content:Lt(e)},{name:"word/_rels/document.xml.rels",content:bt},{name:"word/styles.xml",content:Tt},{name:"word/settings.xml",content:Nt}])}function Lt(e){let t=e?.contacts||[],n=[T([g(`${e?.assetName||"Application"} Risk Profiler Review Notes`,{bold:!0})],{style:"Title",spacingAfter:260}),T([g("Application Details",{bold:!0})],{style:"Heading1"}),It([["Application Name",e?.assetName||"N/A"],["Due Date",Ve(e?.dueOn)||"N/A"],["Survey Completed On",Ve(e?.surveyCompletedOn)||"N/A"],["Review Assessment Date",Ut(e?.reviewedAt)||"N/A"]]),T([g("Contacts",{bold:!0})],{style:"Heading1",spacingBefore:180}),Rt(t),T([g("Review Output",{bold:!0})],{style:"Heading1",spacingBefore:220}),Ot(e?.workQueue||[])].join("");return`<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<w:document
    xmlns:w="${ye}"
    xmlns:w14="${yt}"
    xmlns:mc="${St}"
    ...
    <w:body>
        ...
        ${e.join("")}
    </w:tbl>`}function ce(e){return`<w:tr>${e.join("")}</w:tr>`}function I(e,t={}){return ge([g(e||"",{bold:t.bold})],t)}function ge(e,t={}){let n=['<w:tcW w:w="2500" w:type="pct"/>','<w:tcMar><w:top w:w="80" w:type="dxa"/><w:left w:w="80" w:type="dxa"/><w:bottom w:w="80" w:type="dxa"/><w:right w:w="80" w:type="dxa"/></w:tcMar>'];return t.fill&&n.push(`<w:shd w:fill="${t.fill}"/>`),`<w:tc><w:tcPr>${n.join("")}</w:tcPr>${T(e,{align:t.align})}</w:tc>`}function Ft(e){let t=0,n=[],s=[];e.forEach(o=>{let i=Qe.encode(o.name),d=Qe.encode(o.content),c=_t(d);n.push(A(67324752),m(20),m(0),m(0),m(0),m(0),A(c),A(d.length),A(d.length),m(i.length),m(0),i,d),s.push(A(33639248),m(20),m(20),m(0),m(0),m(0),m(0),A(c),A(d.length),A(d.length),m(i.length),m(0),m(0),m(0),m(0),A(0),A(t),i),t+=30+i.length+d.length});let r=Ge(s),l=[A(101010256),m(0),m(0),m(e.length),m(e.length),A(r),A(t),m(0)];return Pt([...n,...s,...l])}function Bt(){let e=[];for(let t=0;t<256;t+=1){let n=t;for(let s=0;s<8;s+=1)n=n&1?3988292384^n>>>1:n>>>1;e[t]=n>>>0}return e}function _t(e){let t=4294967295;for(let n of e)t=xt[(t^n)&255]^t>>>8;return(t^4294967295)>>>0}function m(e){let t=new Uint8Array(2);return new DataView(t.buffer).setUint16(0,e,!0),t}function A(e){let t=new Uint8Array(4);return new DataView(t.buffer).setUint32(0,e>>>0,!0),t}function Pt(e){let t=Ge(e),n=new Uint8Array(t),s=0;return e.forEach(r=>{n.set(r,s),s+=r.length}),n}function Ge(e){return e.reduce((t,n)=>t+n.length,0)}function je(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&apos;")}function Ve(e){if(!e)return"";let t=new Date(e);return Number.isNaN(t.getTime())?String(e):t.toLocaleDateString(void 0,{year:"numeric",month:"short",day:"2-digit"})}function Ut(e){if(!e)return"";let t=new Date(e);return Number.isNaN(t.getTime())?String(e):t.toLocaleString(void 0,{year:"numeric",month:"short",day:"2-digit",hour:"2-digit",minute:"2-digit"})}function qt(e){return String(e).trim().replace(/[\\/:*?"<>|]+/g,"_").replace(/\s+/g,"_").replace(/^_+|_+$/g,"")||"application"}function Ae(e,t){let n=e;return Object.entries(t).forEach(([s,r])=>{n=n.replace(`{${s}}`,r)}),n}var te=new Map,Qt="https://esats.web.boeing.com",Vt="service-gateway.tas-phx.apps.boeing.com",Ht="https://gtc-ecm.web.boeing.com",Gt="termbank.web.boeing.com",jt={retries:3,retryDelay:1e3,useCache:!0};function Kt(e){return new Promise(t=>setTimeout(t,e))}function Yt(e){try{return new URL(e).hostname===Vt}catch{return!1}}function Wt(e){try{return new URL(e).hostname===Gt}catch{return!1}}function Jt(){return typeof chrome<"u"&&chrome.tabs&&chrome.scripting}function zt(e){return new Promise(t=>{chrome.tabs.query(e,t)})}async function Xt(e){let t=await zt({url:`${e}/*`});return t.find(n=>n.id&&n.status==="complete")||t.find(n=>n.id)}function Zt(e){return new Promise((t,n)=>{chrome.scripting.executeScript(e,s=>{let r=chrome.runtime.lastError;if(r){n(new Error(r.message));return}t(s)})})}async function Ke(e,{pageOrigin:t,label:n,useBearerToken:s}){if(!Jt())throw new Error(`${n} requests require the Chrome scripting permission.`);let r=await Xt(t);if(!r)throw new Error(`Open ${n} in this browser and sign in before running ${n} validation requests.`);let o=(await Zt({target:{tabId:r.id},world:"MAIN",args:[e,s,t],func:async(i,d,c)=>{function N(R){if(!R)return null;let S=String(R).trim();S.startsWith("Bearer ")&&(S=S.slice(7).trim());try{let p=JSON.parse(S);typeof p=="string"?S=p.trim():p&&typeof p=="object"&&(S=p.esatsToken||p.access_token||p.token||p.value||S)}catch{}return S||null}let w=d?N(localStorage.getItem("esatsToken")):null,h={Accept:"application/json, text/plain, */*"};d&&w&&(h.Authorization=`Bearer ${w}`);try{let p=null,H=null;for(let K=1;K<=3;K++){try{if(p=await fetch(i,{method:"GET",headers:h,credentials:"omit",cache:"no-store",referrer:`${c}/`,referrerPolicy:"strict-origin-when-cross-origin"}),p.ok)break;H=new Error(`${p.status} ${p.statusText}`)}catch(x){H=x}K<3&&await new Promise(x=>setTimeout(x,1e3))}if(!p||!p.ok)throw H||new Error("Request failed");let G=await p.text(),j=null;if(G)try{j=JSON.parse(G)}catch{j=G}return{ok:p.ok,status:p.status,statusText:p.statusText,url:p.url,hasAuthorization:d?!!w:!0,data:j}}catch(R){return console.log("ESATS token:",w),console.log("Request URL:",i),console.log("Headers:",h),{ok:!1,status:0,statusText:R.message||"Request failed",hasAuthorization:d?!!w:!0,error:R.message}}}}))?.[0]?.result;if(!o)throw new Error(`${n} request did not return a response.`);if(!o.ok){let i=o.hasAuthorization?"":" No ESATS bearer token was found in the ESATS tab.";throw new Error(`${n} request failed: ${o.status} ${o.statusText}.${i}`)}return o.data}async function en(e){return Ke(e,{pageOrigin:Qt,label:"ESATS",useBearerToken:!0})}async function tn(e){return Ke(e,{pageOrigin:Ht,label:"GTC",useBearerToken:!1})}async function de(e,t={}){let n={...jt,...t};if(n.useCache&&te.has(e))return te.get(e);let s;for(let r=1;r<=n.retries;r++)try{if(Yt(e)){let i=await en(e);return n.useCache&&te.set(e,i),i}if(Wt(e)){let i=await tn(e);return n.useCache&&te.set(e,i),i}let l=await fetch(e,{credentials:"include",headers:{Accept:"application/json, text/plain, */*"},cache:"no-store"});if(!l.ok)throw new Error(`${l.status} ${l.statusText}`);let o=await l.json();return n.useCache&&te.set(e,o),o}catch(l){s=l,r<n.retries&&await Kt(n.retryDelay)}throw s}async function Ee(e){if(!e)return[];let t=Ae(ee.SURVEY_TEMPLATE_QUESTIONS,{id:e});return de(t)}async function be(e){if(!e)return null;let t=Ae(ee.SURVEY_TEMPLATE_DETAIL,{id:e});return de(t)}async function Ye(){return de(ee.SURVEY_TEMPLATES_RP_APP,{useCache:!1})}function We(e){let t=new Map;for(let n of e)n.alternateQuestionId&&t.set(n.alternateQuestionId,n);return t}async function Je(e,t){if(!e||!t)throw new Error("Both survey template IDs are required.");if(Number(e)===Number(t))return{metadata:{fromId:Number(e),toId:Number(t)},newQuestions:[],removedQuestions:[],modifiedQuestions:[]};let[n,s,r,l]=await Promise.all([be(e),Ee(e),be(t),Ee(t)]);if(!n||!r)throw new Error("Unable to load one or both survey template details.");let o=We(s||[]),i=We(l||[]),d=new Set([...o.keys(),...i.keys()]),c=Array.from(d).sort(),N={metadata:{fromId:Number(e),fromVersionNumber:n.versionNumber,fromUpdatedOn:n.updatedOn,fromReleasedOn:n.releasedOn,toId:Number(t),toVersionNumber:r.versionNumber,toUpdatedOn:r.updatedOn,toReleasedOn:r.releasedOn},newQuestions:[],removedQuestions:[],modifiedQuestions:[]};for(let w of c)if(!o.has(w))N.newQuestions.push({alternateQuestionId:w,questionText:i.get(w).questionText});else if(!i.has(w))N.removedQuestions.push({alternateQuestionId:w,questionText:o.get(w).questionText});else{let h=o.get(w),R=i.get(w),S=!1,p={alternateQuestionId:w};h.questionText!==R.questionText&&(p.textChanged={old:h.questionText,new:R.questionText},S=!0);let H=new Set((h.options||[]).map(x=>x.displayValue)),G=new Set((R.options||[]).map(x=>x.displayValue)),j=[...G].filter(x=>!H.has(x)),K=[...H].filter(x=>!G.has(x));(j.length>0||K.length>0)&&(p.optionsChanged={added:j,removed:K},S=!0),S&&N.modifiedQuestions.push(p)}return N}var P=[],D=[],Ne=[],J="",$=[],E=[],L=[],z=!1,se=!1,O="validation",u=null,_={},W={},C=[],f=null,v=null,ne=0,a=e=>document.getElementById(e);document.addEventListener("DOMContentLoaded",nn);async function nn(){await Ze(),await yn(),rn(),await On(),rt(),vn(),kn(),Pn()}async function Ze(){P=await ke(),D=[...P],sn(),oe()}function sn(){Ne=[...new Set(P.map(e=>e.appMgrName))].filter(Boolean).sort(),me()}function an(e){let t=a("ownerOptions");if(!t)return;t.innerHTML="";let n=document.createElement("button");n.type="button",n.className="manager-option",n.textContent="All Application Managers",n.addEventListener("click",()=>{J="",a("ownerSearchInput").value="",ue(),k()}),t.appendChild(n),e.forEach(s=>{let r=document.createElement("button");r.type="button",r.className="manager-option",r.textContent=s,r.addEventListener("click",()=>{J=s,a("ownerSearchInput").value=s,ue(),k()}),t.appendChild(r)})}function et(){let e=a("ownerSearchInput")?.value?.trim()||"";if(!e)return null;try{return new RegExp(e,"i")}catch{return null}}function me(){let e=et(),t=e?Ne.filter(n=>e.test(n)):Ne;an(t)}function ze(){me(),a("ownerOptions")?.classList.remove("hidden")}function ue(){a("ownerOptions")?.classList.add("hidden")}function rn(){a("searchInput")?.addEventListener("input",k),a("regexMode")?.addEventListener("change",k),a("fromDate")?.addEventListener("change",k),a("toDate")?.addEventListener("change",k),a("dateFilterField")?.addEventListener("change",k),a("assessmentStatusFilter")?.addEventListener("change",k),a("ownerSearchInput")?.addEventListener("focus",ze),a("ownerSearchInput")?.addEventListener("input",()=>{J="",me(),ze(),k()}),a("ownerSearchInput")?.addEventListener("keydown",e=>{e.key==="Escape"&&ue()}),document.addEventListener("click",e=>{e.target.closest(".manager-search-select")||ue()}),a("clearFiltersBtn")?.addEventListener("click",on),a("refreshBtn")?.addEventListener("click",mn),a("checkPrereqBtn")?.addEventListener("click",rt),a("selectAllBtn")?.addEventListener("click",un),a("clearSelectionBtn")?.addEventListener("click",pn),a("validateBtn")?.addEventListener("click",fn),a("reviewBtn")?.addEventListener("click",wn),a("cancelBtn")?.addEventListener("click",async()=>{await chrome.runtime.sendMessage({action:"STOP_VALIDATION"})}),a("cancelReviewBtn")?.addEventListener("click",async()=>{await chrome.runtime.sendMessage({action:"STOP_REVIEW"})}),a("retryFailedBtn")?.addEventListener("click",Fn),a("clearResultsBtn")?.addEventListener("click",Dn),a("clearReviewResultsBtn")?.addEventListener("click",Mn),a("exportBtn")?.addEventListener("click",_n),a("validationTabBtn")?.addEventListener("click",()=>U("validation")),a("reviewTabBtn")?.addEventListener("click",()=>U("review")),a("closeReviewNotesModalBtn")?.addEventListener("click",xe),a("reviewNotesModal")?.addEventListener("click",e=>{e.target===a("reviewNotesModal")&&xe()}),a("copyReviewNotesBtn")?.addEventListener("click",Rn),a("selectAllReviewNotesBtn")?.addEventListener("click",Nn),a("downloadReviewNotesBtn")?.addEventListener("click",hn),In()}function k(){let e={search:a("searchInput")?.value||"",regexMode:a("regexMode")?.checked||!1,fromDate:a("fromDate")?.value||"",toDate:a("toDate")?.value||"",dateFilterField:a("dateFilterField")?.value||"surveyCompletedOn",assessmentStatus:a("assessmentStatusFilter")?.value||""};if(D=_e(P,e),J)D=D.filter(t=>t.appMgrName===J);else{let t=et();t&&(D=D.filter(n=>t.test(n.appMgrName||"")))}oe()}function on(){a("searchInput").value="",a("regexMode").checked=!1,a("fromDate").value="",a("toDate").value="",a("dateFilterField").value="surveyCompletedOn",a("assessmentStatusFilter").value="",a("ownerSearchInput").value="",J="",me(),D=[...P],oe()}function oe(){let e=a("assessmentList");e.innerHTML="",D.forEach(t=>{let n=cn(t),s=document.createElement("div");s.className=`assessment-row ${n.className}`,s.innerHTML=`
            ...
            `,e.appendChild(s)}),dn(),tt()}function ln(e){let t=B(e.dueOn||e.raw?.dueOn)||"N/A";if(le(e))return`<strong>Incomplete initiated date:</strong> ${B(e.incompleteInitiatedOn||e.raw?.incompleteInitiatedOn)||"N/A"} \u2022 <strong>Due on:</strong> ${t}`;let n=B(e.surveyCompletedOn||e.raw?.surveyCompletedOn)||"N/A";return`<strong>Due on:</strong> ${t} \u2022 <strong>Survey Completed(Last):</strong> ${n}`}function cn(e){if(le(e)){let r=e.incompleteInitiatedByName||e.raw?.incompleteInitiatedByName||"N/A",l=e.incompleteInitiatedOn||e.raw?.incompleteInitiatedOn;return{label:"Incomplete",className:"status-incomplete",detail:`Incomplete mark \u2022 Initiated by ${r}${l?` \u2022 ${B(l)}`:""}`}}let n=e.attestName||e.raw?.attestName||"N/A",s=e.attestOn||e.raw?.attestOn;return{label:"Completed",className:"status-completed",detail:`Attested by ${n}${s?` \u2022 ${B(s)}`:""}`}}function B(e){if(!e)return"";let t=new Date(e);return Number.isNaN(t.getTime())?e:t.toLocaleDateString(void 0,{year:"numeric",month:"short",day:"2-digit"})}function dn(){document.querySelectorAll(".assessment-checkbox").forEach(e=>{e.addEventListener("change",t=>{let n=Number(t.target.dataset.id);t.target.checked?$.includes(n)||$.push(n):$=$.filter(s=>s!==n),tt()})})}function tt(){a("selectedCount").textContent=`${$.length} Selected`}function un(){$=Pe(D),oe()}function pn(){$=[],oe()}async function mn(){a("refreshBtn").disabled=!0;try{await chrome.runtime.sendMessage({action:"REFRESH_ASSESSMENTS"}),await Ze()}finally{a("refreshBtn").disabled=!1}}async function fn(){let e=P.filter(t=>$.includes(t.assessmentId));if(e.length===0){alert("Select at least one assessment.");return}z=!1,U("validation"),a("progressContainer")?.classList.remove("hidden"),a("cancelBtn")?.classList.remove("hidden"),a("cancelReviewBtn")?.classList.add("hidden"),a("retryFailedBtn")?.classList.add("hidden"),await chrome.runtime.sendMessage({action:"START_VALIDATION",assessments:e})}async function wn(){let e=P.filter(t=>$.includes(t.assessmentId));if(e.length===0){alert("Select at least one assessment.");return}se=!1,U("review"),a("progressContainer")?.classList.remove("hidden"),Y({completed:0,total:e.length,current:"Starting review",startedAt:Date.now(),type:"review"}),a("cancelReviewBtn")?.classList.remove("hidden"),a("cancelBtn")?.classList.add("hidden"),a("retryFailedBtn")?.classList.add("hidden"),a("reviewBtn").disabled=!0,await chrome.runtime.sendMessage({action:"START_REVIEW",assessments:e})}function vn(){setInterval(async()=>{let e=await chrome.storage.local.get(["validationProgress","validationComplete","validationResults","validationError","reviewProgress","reviewComplete","reviewResults","reviewError",b.STORAGE_KEYS.LAST_ACTION]),t=e[b.STORAGE_KEYS.LAST_ACTION]||O;t==="validation"&&e.validationProgress&&!e.validationComplete&&Y(e.validationProgress,"validation"),e.validationComplete&&!z&&(E=e.validationResults||[],Re(E),z=!0,U("validation"),a("exportBtn")?.classList.remove("hidden"),a("clearResultsBtn")?.classList.remove("hidden"),a("cancelBtn")?.classList.add("hidden"),Y(e.validationProgress,"validation"),(await ie()).length?a("retryFailedBtn")?.classList.remove("hidden"):a("retryFailedBtn")?.classList.add("hidden")),t==="review"&&e.reviewProgress&&!e.reviewComplete&&Y(e.reviewProgress,"review"),e.reviewComplete&&!se&&(L=e.reviewResults||[],pe(L),se=!0,U("review"),a("reviewBtn").disabled=!1,Y(e.reviewProgress,"review"),a("cancelReviewBtn")?.classList.add("hidden"),a("clearReviewResultsBtn")?.classList.remove("hidden")),t==="validation"&&e.validationError&&!e.validationProgress&&(a("cancelBtn")?.classList.add("hidden"),a("progressText").textContent=e.validationError),e.reviewError&&(a("reviewBtn").disabled=!1,a("cancelReviewBtn")?.classList.add("hidden"))},1e3)}function Y(e,t=O){if(!e||!e.total)return;let n=Math.round(e.completed/e.total*100),s=e.completedAt||Date.now(),r=e.startedAt||s,l=Math.max(0,s-r),o=e.completed>=e.total,i=!o&&e.completed>0?Te(Math.max(0,l/e.completed*(e.total-e.completed))):o?"Complete":"Calculating",d=t==="review"?"Review":"Validation",c=e.current&&!String(e.current).toLowerCase().includes("completed")?` \u2022 Current: ${e.current}`:"";a("progressText").textContent=o?`${d} complete: ${e.completed}/${e.total} processed \u2022 Time Elapsed: ${Te(l)} \u2022 Estimated Time: Complete`:`${d} in progress: ${e.completed}/${e.total} processed${c} \u2022 Time Elapsed: ${Te(l)} \u2022 Estimated Time: ${i}`,a("progressFill").style.width=`${n}%`}function Te(e){let t=Math.max(0,Math.round(e/1e3));if(t<60)return`${t}s`;let n=Math.floor(t/60),s=t%60;return`${n}m ${s}s`}function U(e){O=e==="review"?"review":"validation",a("validationTabBtn")?.classList.toggle("active",O==="validation"),a("reviewTabBtn")?.classList.toggle("active",O==="review"),a("resultsContainer")?.classList.toggle("hidden",O!=="validation"),a("reviewResultsContainer")?.classList.toggle("hidden",O!=="review"),q()}function q(){let e=E&&E.length>0,t=L&&L.length>0;a("exportBtn")?.classList.toggle("hidden",O!=="validation"||!e),a("clearResultsBtn")?.classList.toggle("hidden",O!=="validation"||!e),a("clearReviewResultsBtn")?.classList.toggle("hidden",O!=="review"||!t)}function Re(e){let t=a("validationCardsContainer");if(t.innerHTML="",!e||e.length===0){q();return}e.forEach(n=>{let s=document.createElement("div");s.className="result-card";let r=n.results&&n.results.some(i=>i.reason==="Question identifier was not found in the survey questions."),l=n.summary?n.summary.score:null,o=l!==null&&l<90;s.innerHTML=`
                ...
                <details>
                    ...
                    `}
            `,t.appendChild(s)}),document.querySelectorAll(".download-context").forEach(n=>{n.addEventListener("click",()=>{Bn(n.dataset.id)})}),q()}function pe(e){let t=a("reviewCardsContainer");if(t.innerHTML="",!e||e.length===0){t.innerHTML='<div class="review-empty">No review results yet.</div>',q();return}e.forEach(n=>{let s=document.createElement("div"),r=n.status==="Incomplete"?"status-incomplete":"status-completed";s.className=`review-card ${r}`;let l=n.status==="Incomplete"?`
            ...
            `,t.appendChild(s)}),document.querySelectorAll(".review-notes-btn").forEach(n=>{n.addEventListener("click",()=>gn(n.dataset.id))}),q()}async function hn(){if(!u||u.error)return;let e=nt(u);e.length!==0&&await He({...u,workQueue:e})}function gn(e){let t=L.find(n=>String(n.assessmentId)===String(e));!t||t.error||(u=t,a("reviewNotesTitle").textContent=t.assetName||"Review Notes",a("reviewNotesMeta").innerHTML=t.notesMetaHtml||"",An(t),Ie(),a("reviewNotesModal")?.classList.remove("hidden"))}function xe(){a("reviewNotesModal")?.classList.add("hidden"),u=null}async function yn(){W=(await chrome.storage.local.get("reviewQuestionNotes")).reviewQuestionNotes||{}}async function Sn(){await chrome.storage.local.set({reviewQuestionNotes:W})}function An(e){let t=V(e);_[t]||(_[t]=(e.workQueue||[]).map((n,s)=>Z(n,s)))}function Ie(){let e=a("reviewNotesContent");if(!e||!u)return;let t=u.workQueue||[];if(t.length===0){e.innerHTML='<div class="review-output-empty">No reachable unanswered work queue items were found.</div>',Ce();return}let n=V(u),s=new Set(_[n]||[]);e.innerHTML=t.map((r,l)=>En(r,l,s.has(Z(r,l)))).join(""),bn(),Ce()}function En(e,t,n){let s=Z(e,t),r=st(u,e,t),l=(e.options||[]).length?(e.options||[]).map(o=>`<li>${y(Ln(o))}</li>`).join(""):"<li>&lt;no options&gt;</li>";return`
