...
</Types>`,bt=`<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
...
<w:settings xmlns:w="${Ee}">
    <w:updateFields w:val="true"/>
</w:settings>`,He=new TextEncoder,xt=Bt();async function Ge(e){let t=new Blob([Ct(e)],{type:"application/vnd.openxmlformats-officedocument.wordprocessingml.document"}),n=URL.createObjectURL(t),s=document.createElement("a");s.href=n,s.download=`${Ut(e?.assetName||"application")}_RISK-PRofiler_review_notes.docx`,s.click(),URL.revokeObjectURL(n)}function Ct(e){return Ft([{name:"[Content_Types].xml",content:Et},{name:"_rels/.rels",content:bt},{name:"word/document.xml",content:Lt(e)},{name:"word/_rels/document.xml.rels",content:At},{name:"word/styles.xml",content:Tt},{name:"word/settings.xml",content:Nt}])}function Lt(e){let t=e?.contacts||[],n=[T([g(`${e?.assetName||"Application"} Risk Profiler Review Notes`,{bold:!0})],{style:"Title",spacingAfter:260}),T([g("Application Details",{bold:!0})],{style:"Heading1"}),Rt([["Application Name",e?.assetName||"N/A"],["Due Date",ge(e?.dueOn)||"N/A"],["Survey Completed On (Last)",ge(e?.surveyCompletedOn)||"N/A"],["Review Assessment Date",ge(e?.reviewedAt)||"N/A"]]),T([g("Contacts",{bold:!0})],{style:"Heading1",spacingBefore:180}),It(t),T([g("Review Output",{bold:!0})],{style:"Heading1",spacingBefore:220}),Ot(e?.workQueue||[])].join("");return`<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<w:document
    xmlns:w="${Ee}"
    xmlns:w14="${yt}"
    xmlns:mc="${St}"
    ...
    <w:body>
...
</w:document>`}function It(e){if(e.length===0)return T([g("No Application Manager or Business System Manager details were found.")]);let t=[ce([R("Contact Type",{bold:!0,fill:"E8EEFC"}),R("Name",{bold:!0,fill:"E8EEFC"}),R("BEMS ID",{bold:!0,fill:"E8EEFC"}),R("Email",{bold:!0,fill:"E8EEFC"})]),...e.map(n=>ce([R(n.contactType||"N/A"),R(n.associatedTo||"N/A"),R(n.bemsId||"N/A"),R(n.email||"N/A")]))];return be(t)}function Rt(e){return be(e.map(([t,n])=>ce([R(t,{bold:!0,fill:"F3F4F6"}),R(n)])))}function Ot(e){return e.length===0?T([g("No reachable unanswered work queue items were found.")]):e.map((t,n)=>[t.status?T([g(t.status,{bold:!0,color:"315FD6"})],{spacingBefore:n===0?80:180,spacingAfter:80}):"",kt(t.questionGroup||"N/A",t.questionId||"N/A"),he("Question",t.question||"N/A"),he("Answer Type",t.answerType||"N/A"),t.asaNotes?he("ASA Notes",t.asaNotes,{fill:"FFF7CC"}):"",T([g("Options",{bold:!0})]),...$t(t.options||[]),Mt()].join("")).join("")}function $t(e){return(e.length?e:[{index:1,internalValue:"<no options>"}]).map(n=>T([Dt(),g(` ${n.internalValue||n.displayValue||"<no options>"}`)],{indentLeft:360,spacingAfter:70}))}function kt(e,t){return be([ce([ye([g("Category: ",{bold:!0}),g(e)]),ye([g("Question ID: ",{bold:!0}),g(t)],{align:"right"})])],{noBorders:!0})}function he(e,t,n={}){return T([g(`${e}: `,{bold:!0}),g(t)],n)}function Dt(){return`
        <w:sdt>
            <w:sdtPr>
        ...
        ${e.join("")}
            ...
            `,t.appendChild(s)}),document.querySelectorAll(".review-notes-btn").forEach(n=>{n.addEventListener("click",()=>hn(n.dataset.id))}),q()}async function vn(){if(!u||u.error)return;let e=nt(u);e.length!==0&&await Ge({...u,workQueue:e})}function hn(e){let t=L.find(n=>String(n.assessmentId)===String(e));!t||t.error||(u=t,a("reviewNotesTitle").textContent=t.assetName||"Review Notes",a("reviewNotesMeta").innerHTML=t.notesMetaHtml||"",Sn(t),$e(),a("reviewNotesModal")?.classList.remove("hidden"))}function Le(){a("reviewNotesModal")?.classList.add("hidden"),u=null}async function gn(){Y=(await chrome.storage.local.get("reviewQuestionNotes")).reviewQuestionNotes||{}}async function yn(){await chrome.storage.local.set({reviewQuestionNotes:Y})}function Sn(e){let t=V(e);_[t]||(_[t]=(e.workQueue||[]).map((n,s)=>Z(n,s)))}function $e(){let e=a("reviewNotesContent");if(!e||!u)return;let t=u.workQueue||[];if(t.length===0){e.innerHTML='<div class="review-output-empty">No reachable unanswered work queue items were found.</div>',Ie();return}let n=V(u),s=new Set(_[n]||[]);e.innerHTML=t.map((o,l)=>En(o,l,s.has(Z(o,l)))).join(""),bn(),Ie()}function En(e,t,n){let s=Z(e,t),o=st(u,e,t),l=Ln(e);return`
    ...
    `}function bn(){document.querySelectorAll(".review-question-checkbox").forEach(e=>{e.addEventListener("change",()=>{An(e.dataset.key,e.checked),Ie()})}),document.querySelectorAll(".review-note-icon-btn").forEach(e=>{e.addEventListener("click",()=>Nn(e.dataset.key))}),document.querySelectorAll(".review-note-save-btn").forEach(e=>{e.addEventListener("click",()=>xn(e.dataset.key))})}function An(e,t){let n=V(u),s=new Set(_[n]||[]);t?s.add(e):s.delete(e),_[n]=[...s]}function Tn(){if(!u)return;let e=V(u),t=(u.workQueue||[]).map((s,o)=>Z(s,o)),n=_[e]||[];_[e]=n.length===t.length?[]:t,$e()}function Ie(){let e=a("downloadReviewNotesBtn"),t=a("selectAllReviewNotesBtn");if(!e||!u)return;let n=(u.workQueue||[]).length,s=nt(u).length;e.textContent=`Download Review Notes (${s}/${n})`,e.disabled=s===0,t&&(t.textContent=s===n&&n>0?"Deselect All":"Select All",t.disabled=n===0)}function nt(e){let t=V(e),n=new Set(_[t]||[]);return(e.workQueue||[]).map((s,o)=>({item:s,index:o,key:Z(s,o)})).filter(s=>n.has(s.key)).map(s=>({...s.item,asaNotes:st(e,s.item,s.index)}))}function Nn(e){document.querySelector(`[data-note-editor="${at(e)}"]`)?.classList.toggle("hidden")}async function xn(e){let n=document.querySelector(`[data-note-input="${at(e)}"]`)?.value.trim()||"",s=V(u);Y[s]||(Y[s]={}),Y[s][e]=n,await yn(),$e()}function st(e,t,n){let s=V(e),o=Z(t,n);return Y[s]?.[o]||""}function V(e){return String(e?.assessmentId||"active")}function Z(e,t){return String(e?.surveyTemplateQuestionId||e?.questionId||`question-${t}`)}function Cn(e){return e.internalValue||e.displayValue||"<no options>"}function Ln(e){let t=(e.options||[]).length?e.options:[{internalValue:"<no options>"}],n=String(e.answerType||"").toLowerCase()==="multi select"?"checkbox":"radio",s=n==="checkbox"?"review-option-checkbox-square":"review-option-checkbox-circle";return t.map(o=>`
